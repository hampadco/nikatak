#pragma checksum "c:\Users\MS\Desktop\Nikatak\faraboom\Areas\Admin\Views\Ticket\index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b2921c45997ef55ebeb01e61654db33c291b583d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b2921c45997ef55ebeb01e61654db33c291b583d", @"/Areas/Admin/Views/Ticket/index.cshtml")]
...
<div class=""container-fluid pt-8"">
        ...
        <div class=""btn-group mb-0"">
            ...
            <div class=""dropdown-menu"" x-placement=""bottom-start""
                ...
                <a class=""dropdown-item"" href=""#""><i class=""fas fa-eye mr-2""></i>مشاهده جزئیات
                    صفحه</a>
                <a class=""dropd");
            WriteLiteral(@"own-item"" href=""#""><i class=""fas fa-edit mr-2""></i>ویرایش
                    صفحه</a>
    ...
    <div class=""email-app card shadow"">
        <nav class=""p-0"">
            <div class=""card-body"">
                <a href=""email-compose.html"" class=""btn btn-primary btn-block  btn-sm mt-1 mb-1"">ارسال ایمیل</a>
            </div>
            <ul class=""nav"">
                <li class=""nav-item"">
                ...
                <li class=""nav-item"">
                    <a class");
            WriteLiteral(@"=""nav-link mr-0"" href=""#""><i class=""fas fa-rocket""></i> ارسال
                        شده</a>
                </li>
                <li class=""nav-item"">
        ...
        <div class=""inbox p-0"">
            <div class=""card-body d-none d-lg-block"">
                ...
                <div class=""toolbar "">
                   ...
                   ");
            WriteLiteral(@"         <span class=""fas fa-envelope""></span>
                        </button>
                    ...
                    <button type=""button""");
            WriteLiteral(@" class=""mt-1 mb-1 btn btn-sm btn-light"" title=""حذف"">
            ...
            WriteLiteral(@"                    <div class=""checkbox"">
                        ...
                        <div class=""media-body"">
                            <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">لورم ایپسوم</a>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" datetime=""2017"">12:35
                                        قبل از
                                        ظهر</time><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                                </small>
 ");
            WriteLiteral(@"                           </div>
                            <p class=""msg"">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم لورم
            ...
            WriteLiteral(@" <div class=""media-body"">
                            <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">عنوان نمونه</a>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" datetime=""2017"">12:35
                                        قبل از
                                        ظهر</time><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                                </small>
                    ...
                    <div class=""media"">
                        <div class=""pull-left"">
                            <div class=""controls"">
                                <div class=""checkbox"">
               ");
            WriteLiteral(@"                     <input type=""checkbox"" id=""basic_checkbox_3"">
                        ...
                        <div class=""media-body"">
                            <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">لورم ایپسوم</a>
                                <span class=""badge bg-danger text-white"">گوگل</span>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" datetime=""2017"">12:35
                                        قبل از
                                        ظهر</time><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                ");
            ...
            WriteLiteral(@"     </div>
                        <div class=""media-body"">
                            <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">لورم ایپسوم متن
                                    ساختگی</a>
                                <span class=""badge bg-warning text-white"">آکادمی آموزش</span>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" datetime=""2017"">12:35
                                        قبل از
                                        ظهر</time><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                                </small>
            ...
            WriteLiteral(@"edia"">
                        ...
                        <div class=""media-body"">
                            <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">اپراتور شبکه</a>
                                <span class=""badge bg-danger text-white"">شغل</span>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" date");
            WriteLiteral(@"time=""2017"">12:35
                                        قبل از
                                        ظهر</time><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                                </small>
                            </div>
                    ...
                    <div class=""media"">
                        <div class=""pull-left"">
                            <div class=""controls"">
                                ...
                                <a href=""javascript:void(0);"" class=""favourite col-amber hi");
            WriteLiteral(@"dden-sm-down""
                                    data-toggle=""active""><i class=""zmdi zmdi-star""></i></a>
                            </div>
                        </div>
                        <div class=""media-body"">
...
");
            WriteLiteral(@"                        </div>
                ...
                <li class=""list-group-item"">
                    <div class=""media"">
                        ...
                        <div class=""media-body"">
                            <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">حسابدار شرکت</a>
                                <s");
            WriteLiteral(@"pan class=""badge bg-success text-white"">شغل</span>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" datetime=""2017"">12:35
                                        قبل از
                                        ظهر</time><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                                </small>
            ...
            BeginWriteAttribute("checked", " checked=\"", 17353, "\"", 17363, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                        ...
                        <div class=""media-body"">
                            <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">ترجمه متون انگلیسی</a>
                                <span class=""badge bg-primary text-white"">آکادمی آموزش</span>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" datetime=""2017"">12:35
                                        قبل از
                                        ظهر</time><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                                </small>
 ...
 ");
            WriteLiteral(@"                           <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">اپراتور شبکه</a>
                                <span class=""badge bg-success text-white"">شغل</span>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" datetime=""2017"">12:35
                                        قبل از
                                        ظهر</time><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                                </small>
            ...
            WriteLiteral(@"                    <div class=""checkbox"">
                        ...
                        <div class=""media-body"">
                            <div class=""media-heading"">
                                <a href=""mail-single.html"" class=""mr-2"">لورم ایپسوم</a>
                                <span class=""badge bg-info text-white"">خانوادگی</span>
                                <small class=""float-left text-muted""><time class=""hidden-sm-down"" datetime=""2017"">12:35
                                        قبل از
                                        ظهر</time");
            WriteLiteral(@"><i class=""zmdi zmdi-attachment-alt ml-2""></i>
                                </small>
                            </div>
                            <p class=""msg"">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم لورم
                                ایپسوم متن ساختگی با تولید سادگی </p>
