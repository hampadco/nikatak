...
namespace faraboom.Areas.persenel.Controllers
{
   [Area ("persenel")]
   ...
   public IActionResult send()
        {
            ...
            if (eror != null)
            {
             ...
             var qname=db.Tbl_UserPersenel.Where(a=>a.UserNameUs== (User.Identity.GetId())).SingleOrDefault();
             List<Vm_Message> qlist=new List<Vm_Message>();
             foreach (var item in quser)
             {
