...
namespace faraboom.Areas.Adminsite.Controllers
{
    public class EditController:BaseController
    {
        ...
        public static string msg,Fphotos,FNationalcard,FNationalcardback,FCertificate,FShaba,FDegreeeducation,FPostalcodeDoc,FDocument,FBadbackground,FReceipt;
          ...
          public EditController(ContextHampadco _db,IWebHostEnvironment  env) :base(_db,env)
        {
         ...
         public IActionResult index (string? Username,int? id) {
            ...
            var quser = db.Tbl_infos.Where (a => a.UserNameId ==Username ).SingleOrDefault ();
           ...
           public async Task<IActionResult> Update (Vm_info Q) {

            var quser = db.Tbl_infos.Where (a => a.UserNameId == Q.UserNameId).SingleOrDefault ();
            ///upload data
            ///FNationalcard data///////////
            if (Q.Fphotos!=null)
            {
         ...
         //FBadbackground////////////
            ...
            if (quser != null) {
                ...
                db.SaveChanges ();
                return RedirectToAction ("index", "Edit", new { area = "Adminsite", id = 1 ,username=Q.UserNameId });

            }
            return RedirectToAction ("index", "Edit", new { area = "Adminsite", id = 0, username=Q.UserNameId });
        }
    }
}